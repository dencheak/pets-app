package denis.lishchuk.pets.security.config;
...
public class TokenAuthentificationFilter extends GenericFilterBean {
    ...
    @Value("${external.url.pattern.homeAdmin}")
    private String homeAdminPattern;

    @Value("${external.url.pattern.homeShelterAdmin}")
    private String homeShelterAdminPattern;
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        List<String> urlPatterns = Arrays.asList(externalUrlPattern,
                homePattern, imagesUrlPattern, cssUrlPattern, signPattern, jsUrlPattern, registrationPattern, homeAdminPattern, homeShelterAdminPattern);
